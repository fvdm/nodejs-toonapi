...
function temperatureUpdate (value, scale, callback) {
  var options = {
    method: 'POST',
...
function temperatureStatesList (callback) {
  var options = {
    method: 'GET',
...
function temperatureStatesUpdate (temperatureState, state, callback) {
  var tempStates = {
    manual: 0,
    program: 1
  };
...
function temperatureSetup (parent) {
  app = parent;

  return {
    update: temperatureUpdate,
    states: {
      list: temperatureStatesList,
      update: temperatureStatesUpdate
    }
  };
}

module.exports = temperatureSetup;
