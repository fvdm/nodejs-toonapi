...
function devicesDeviceGet (deviceId, callback) {
  var options = {
    method: 'GET',
...
function devicesDeviceUpdate (deviceId, obj, callback) {
  var options = {
    method: 'PUT',
    path: '/api/toon/v1/devices/' + deviceId,
    json: obj
...
function devicesDeviceData (deviceId, params, callback) {
  var options = {
    method: 'GET',
    path: '/api/toon/v1'
  };
...
function devicesDeviceFlows (deviceId, params, callback) {
  var options = {
    method: 'GET',
    path: '/api/toon/v1'
  };
...
function devicesListAll (callback) {
  var options = {
    method: 'GET',
...
function devicesUpdateAll (arr, callback) {
  var options = {
    method: 'PUT',
    path: '/api/toon/v1/devices',
    json: arr
...
function devicesSetup (parent) {
  app = parent;

  return {
    device: {
      get: devicesDeviceGet,
      update: devicesDeviceUpdate,
      data: devicesDeviceData,
      flows: devicesDeviceFlows
    },
    list: devicesListAll,
    update: devicesUpdateAll
  };
}

module.exports = devicesSetup;
